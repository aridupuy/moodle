...
$string['forceloginforprofileimage_help'] = 'Si se habilita, los usuarios deben iniciar sesión para ver las imágenes del perfil y la imagen por defecto de usuario será empleada en todos los correos electrónicos de notificación.';
